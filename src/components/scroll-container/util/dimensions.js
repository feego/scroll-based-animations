 ...
 */
export const defaultScrollPosition = {
  scrollTop: 0,
  scrollLeft: 0,
  scrollWidth: 0,
  scrollHeight: 0,
 ...
 */
export const defaultBoundingRect = {
  top: 0,
  right: 0,
  bottom: 0,
  left: 0,
 ...
 */
export const serializeScrollPosition = ({ scrollTop, scrollLeft, scrollWidth, scrollHeight }) => ({
  scrollTop,
  scrollLeft,
  scrollWidth,
  scrollHeight,
 ...
 */
export const serializeBoundingRect = ({ top, right, bottom, left, width, height }) => ({
  top,
  right,
  bottom,
  left,
