 ...
 */
export let originalBodyPointerEvents = null;
...
export const getScrollPosition = () =>
  typeof window !== 'undefined'
    ? {
        scrollTop: 'scrollY' in window ? window.scrollY : document.documentElement.scrollTop,
        scrollLeft: 'scrollX' in window ? window.scrollX : document.documentElement.scrollLeft,
 ...
 *
 * @param {Boolean} passive - Whether the event listener should be passive or not.
 *
 * @returns {undefined} Undefined.
 */
export const createAttachScrollListener = (passive = true) => (scrollHandler) =>
 ...
 * @returns {undefined} Undefined.
 */
export const detachScrollListener = (scrollHandler) => window.removeEventListener('scroll', scrollHandler);
